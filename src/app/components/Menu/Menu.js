            ...
            <span className="flex flex-col">
              {menuItemsArray.map((menuItem, menuItemIndex) => (
                <Link
                  ...
                  href={menuItem.link}
                  key={menuItemIndex}
                  className="flex justify-between items-center rounded m-1 bg-appBlue/80  text-appGrey border border-appGrey/50 cursor-pointer shadow-xl hover:text-black transform transition-transform duration-300"
                >
