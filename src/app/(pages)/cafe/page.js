  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="mt-40">
          <Text textValue="Genießen Sie bei uns eine Auszeit vom Alltag und lassen Sie sich von der gemütlichen Atmosphäre und unserem freundlichen Service verzaubern. Egal ob Sie auf einen duftenden Kaffee, ein Stück hausgemachten Kuchen oder eine unserer leckeren Torten vorbeischauen wir freuen uns darauf, Sie zu verwöhnen." />

          <ResponsiveGallery images={imageUrls} />
          <Text textValue="Machen Sie es sich auf unserer sonnigen Terrasse bequem oder genießen Sie die Gemütlichkeit unseres Innenbereichs. Wir freuen uns auf Ihren Besuch." />
        </div>
      </div>
    </>
  );
