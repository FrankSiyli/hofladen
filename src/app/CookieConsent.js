  ...
  return (
    <div className="fixed inset-0 bg-slate-700 bg-opacity-70 z-30">
      <div className="fixed bottom-0 left-0 right-0 flex flex-col gap-5 text-center justify-center px-4 py-8 bg-appGrey">
        ...
        Diese Website verwendet Cookies. Durch den Besuch der Website erklären Sie sich mit der Verwendung von Cookies einverstanden. Weitere Informationen über die Verwendung Ihrer Daten finden Sie in unserer <Link className="text-appBlue underline" href="/datenschutz">Datenschutzerklärung</Link>
        </span>
